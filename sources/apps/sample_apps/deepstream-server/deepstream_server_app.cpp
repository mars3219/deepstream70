...
static gboolean
start_rtsp_streaming (guint rtsp_port_num, guint udpsink_port_num,
    ...
    sprintf (udpsrc_pipeline,
              ...
              udpsink_port_num, udp_buffer_size);
    ...
    g_print
            ("\n *** DeepStream: Launched RTSP Streaming at rtsp://localhost:%d/stream ***\n\n",
             rtsp_port_num);
